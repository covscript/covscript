 ...
 *   version.
 */
#define COVSCRIPT_VERSION_NUM 3, 5, 0, 1
#define COVSCRIPT_VERSION_STR "3.5.0 Castor fiber(Unstable) Build 1"
#define COVSCRIPT_STD_VERSION 260701
#define COVSCRIPT_API_VERSION 260701
#define COVSCRIPT_ABI_VERSION 260701
