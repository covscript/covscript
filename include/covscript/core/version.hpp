 ...
 *   version.
 */
#define COVSCRIPT_VERSION_NUM 3, 4, 6, 6
#define COVSCRIPT_VERSION_STR "3.4.6 Castor fiber(Stable) Build 6"
#define COVSCRIPT_STD_VERSION 251101
#define COVSCRIPT_API_VERSION 251106
#define COVSCRIPT_ABI_VERSION 251106
