 ...
 *   version.
 */
#define COVSCRIPT_VERSION_NUM 3, 5, 2, 6
#define COVSCRIPT_VERSION_STR "3.5.2 Falco peregrinus(Unstable) Build 6"
#define COVSCRIPT_STD_VERSION 260801
#define COVSCRIPT_API_VERSION 261001
#define COVSCRIPT_ABI_VERSION 261001
