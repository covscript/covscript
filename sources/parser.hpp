...
namespace cov_basic {
	...
	mapping<signal_types,int> signal_level_map = {
		...
		{signal_types::und_,9},{signal_types::abo_,9},{signal_types::asi_,1},{signal_types::pair_,0},{signal_types::equ_,9},{signal_types::ueq_,9},{signal_types::aeq_,9},{signal_types::neq_,9},{signal_types::link_,1},
