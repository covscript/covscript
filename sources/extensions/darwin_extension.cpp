...
// Graphics
	...
	void init()
	{
		darwin_ext.add_var("load",cov::any::make_constant<native_interface>(load));
		darwin_ext.add_var("fit_drawable",cov::any::make_constant<native_interface>(fit_drawable));
		darwin_ext.add_var("set_frame_limit",cov::any::make_constant<native_interface>(set_frame_limit));
		darwin_ext.add_var("update_drawable",cov::any::make_constant<native_interface>(update_drawable));
		darwin_ext.add_var("clear_drawable",cov::any::make_constant<native_interface>(clear_drawable));
		darwin_ext.add_var("fill_drawable",cov::any::make_constant<native_interface>(fill_drawable));
		darwin_ext.add_var("resize_drawable",cov::any::make_constant<native_interface>(resize_drawable));
		darwin_ext.add_var("get_height",cov::any::make_constant<native_interface>(get_height));
		darwin_ext.add_var("get_width",cov::any::make_constant<native_interface>(get_width));
		darwin_ext.add_var("draw_point",cov::any::make_constant<native_interface>(draw_point));
		darwin_ext.add_var("draw_picture",cov::any::make_constant<native_interface>(draw_picture));
		darwin_ext.add_var("draw_line",cov::any::make_constant<native_interface>(draw_line));
		darwin_ext.add_var("draw_rect",cov::any::make_constant<native_interface>(draw_rect));
		darwin_ext.add_var("fill_rect",cov::any::make_constant<native_interface>(fill_rect));
		darwin_ext.add_var("draw_triangle",cov::any::make_constant<native_interface>(draw_triangle));
		darwin_ext.add_var("fill_triangle",cov::any::make_constant<native_interface>(fill_triangle));
		darwin_ext.add_var("draw_string",cov::any::make_constant<native_interface>(draw_string));
