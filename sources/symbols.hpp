...
namespace cs {
	...
	enum class action_types {
		import_,struct_,block_,endblock_,define_,constant_,as_,if_,else_,switch_,case_,default_,while_,loop_,until_,for_,to_,step_,iterate_,break_,continue_,function_,return_
	};
	...
	mapping<std::string,action_types> action_map= {
		{"import",action_types::import_},{"struct",action_types::struct_},{"block",action_types::block_},{"end",action_types::endblock_},{"var",action_types::define_},{"const",action_types::constant_},{"as",action_types::as_},{"if",action_types::if_},{"else",action_types::else_},{"switch",action_types::switch_},{"case",action_types::case_},{"default",action_types::default_},
