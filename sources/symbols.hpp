...
namespace cov_basic {
	...
	enum class action_types {
		import_,struct_,block_,endblock_,define_,constant_,as_,if_,then_,else_,switch_,case_,default_,while_,loop_,until_,do_,for_,to_,step_,break_,continue_,function_,return_
	};
	...
	mapping<std::string,action_types> action_map= {
		...
		{"while",action_types::while_},{"until",action_types::until_},{"loop",action_types::loop_},/*{"do",action_types::do_},*/{"for",action_types::for_},{"to",action_types::to_},{"step",action_types::step_},{"break",action_types::break_},{"continue",action_types::continue_},{"function",action_types::function_},{"return",action_types::return_}
	};
