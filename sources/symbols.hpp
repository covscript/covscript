...
namespace cov_basic {
	...
	enum class action_types {
		import_,struct_,block_,endblock_,define_,as_,if_,then_,else_,switch_,case_,default_,while_,loop_,until_,do_,for_,to_,step_,break_,continue_,function_,return_
	};
